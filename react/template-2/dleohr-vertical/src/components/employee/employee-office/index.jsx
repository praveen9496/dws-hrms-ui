  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: "Manager",
        render: (text, record) => (
          <a href="#0" className="btn btn-outline-success btn-sm">
            {text}
          </a>
        ),
      },
      {
        ...
        dataIndex: "Team",
        render: (text, record) => (
          <a href="#0" className="btn btn-outline-warning btn-sm">
            {text}
          </a>
        ),
      },
      ...
      <div className="page-wrapper">
        <div className="container-fluid">
          <div className="row grow">
            ...
            <div className="col-xl-9 col-lg-8 grow col-md-12">
              <TopSidebar />
                ...
                <div className="card-body align-center">
                  ...
                  <ul className="nav nav-tabs float-right border-0 tab-list-emp">
                    <li className="nav-item">
                      <Link
                        className="nav-link border-0 font-23 active grid-view"
                        to="/employee-office"
                      >
                ...
                <div className="col-12">
                  <div className="card ctm-border-radius shadow-sm">
                    <div className="card-header">
                      <h4 className="card-title mb-0">Create New Office</h4>
                    </div>
                    <div className="card-body">
                      ...
                      <button
                        type="button"
                        className="btn btn-theme button-1 text-white float-right ctm-border-radius"
                        onClick={() => this.handleShow("add")}
                      >
                        Create Office
                      </button>
                  ...
                  <div className="card ctm-border-radius shadow-sm">
                    <div className="card-header">
                      ...
                      >
                        <a
                          href="#/"
                          className="btn btn-theme mt-2 text-white float-right ctm-border-radius"
                          title="Edit"
                    ...
                    <div className="card-body">
                      ...
                      <Link to="employment">
                        ...
                        >
                          <img className="img-fluid" alt="avatar" src={IMG06} />
                        </span>
                      </Link>
                      <Accordion defaultActiveKey="0">
                        <Accordion.Toggle
                          variant="link"
                          eventKey="0"
                          className="btn btn-theme float-right ctm-border-radius text-white coll-arrow"
                        ...
                        >
                          <Table
                            className="table custom-table table-hover table-hover"
        ...
        >
          ...
          <Modal.Body>
            ...
            <button
              type="button"
              className="btn btn-danger float-right ctm-border-radius ml-3"
              data-dismiss="modal"
            >
              Cancel
            </button>
