							...
							<div className="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div className="card-body">
										<div className="list-group list-group-horizontal-lg" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab1' ? 'active' : ''}`} id="v-pills-home-tab"  data-target="#v-pills-home" onClick={()=>this.handlemanage('tab1')}>Manage Details</a>
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab2' ? 'active' : ''}`} id="v-pills-profile-tab" data-target="#v-pills-profile" onClick={()=>this.handlemanage('tab2')}>Manage Time Off</a>
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab3' ? 'active' : ''}`} id="v-pills-messages-tab"  data-target="#v-pills-messages" onClick={()=>this.handlemanage('tab3')}>Manage Salaries</a>
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab4' ? 'active' : ''}`} id="v-pills-settings-tab" data-target="#v-pills-settings" onClick={()=>this.handlemanage('tab4')}>Manage All </a>
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab5' ? 'active' : ''}`} id="v-pills-settings-tab" data-target="#v-pills-settings" onClick={()=>this.handlemanage('tab5')}>Manage Account Settings </a>
										</div>
									</div>
								</div>
                            {/*card*/}
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch5"></label>
																</div>
															</td>
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch6" checked />
																	<label className="custom-control-label" htmlFor="switch6"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch7"></label>
																</div>
															</td>
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch8" checked />
																	<label className="custom-control-label" htmlFor="switch8"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch10"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch11"></label>
																</div>
															</td>
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch12" checked />
																	<label className="custom-control-label" htmlFor="switch12"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch13"></label>
																</div>
															</td>
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch14" checked />
																	<label className="custom-control-label" htmlFor="switch14"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch15"></label>
																</div>
															</td>
															<td>
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch16" checked />
																	<label className="custom-control-label" htmlFor="switch16"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch17"></label>
																</div>
															</td>
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch38" checked />
																	<label className="custom-control-label" htmlFor="switch38"></label>
																</div>
															</td>
														</tr>
													</tbody>
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch18"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch19"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch20"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch21"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch22"></label>
																</div>
															</td>
														</tr>
													</tbody>
														...
														<tr>
															...
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch23"></label>
																</div>
															</td>
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	<input type="checkbox" className="custom-control-input" id="switch24" checked />
																	<label className="custom-control-label" htmlFor="switch24"></label>
																</div>
															</td>
														</tr>
													</tbody>
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch25"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch26"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch27"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch28"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch29"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch30"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch31"></label>
																</div>
															</td>
														</tr>
													</tbody>
														...
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch32"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch33"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch34"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch35"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td>
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch36"></label>
																</div>
															</td>
														</tr>
														<tr>
															...
															<td className="pb-0">
																<div className="custom-control custom-switch">
																	...
																	<label className="custom-control-label" htmlFor="switch37"></label>
																</div>
															</td>
														</tr>
													</tbody>
