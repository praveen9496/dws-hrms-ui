							...
							<div className="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div className="card-body">
										<div className="list-group list-group-horizontal-lg" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab1' ? 'active' : ''}`} id="v-pills-home-tab"  data-target="#v-pills-home" onClick={()=>this.handlemanage('tab1')}>View Details</a>
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab2' ? 'active' : ''}`} id="v-pills-profile-tab"  data-target="#v-pills-profile" onClick={()=>this.handlemanage('tab2')}>View Salaries</a>
