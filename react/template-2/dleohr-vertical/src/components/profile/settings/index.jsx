	...
	handleClose = () => {
	  ...
	  handleShow = (id) => {
								...
								<div className="col-lg-6 d-flex">
									<div className="card reminder flex-fill ctm-border-radius shadow-sm">
										...
										<div className="card-body">
											...
											<div className="custom-control custom-checkbox mb-3">
												<input type="checkbox" className="custom-control-input" id="weekly-payroll" />
								...
								<div className="col-md-12">
									<div className="card ctm-border-radius shadow-sm">
										...
										<div className="card-body">
											...
											<div className="custom-control custom-checkbox mb-3">
												<input type="checkbox" className="custom-control-input" id="Work"  />
											...
											<div className="custom-control custom-checkbox mb-3">
												<input type="checkbox" className="custom-control-input" id="Key1"  />
											...
											<div className="custom-control custom-checkbox mb-3">
												<input type="checkbox" className="custom-control-input" id="Offboardings"  />
											...
											<div className="custom-control custom-checkbox mb-3">
												<input type="checkbox" className="custom-control-input" id="Home"  />
        ...
        >
          ...
          <Modal.Body>
          <div className="input-group mb-3">
							<input type="text" className="form-control" placeholder="Add Bank Name" Value=" Life Essence Banks, Inc." />
							<div className="input-group-append">
								<button className="btn btn-theme button-1 text-white ctm-border-radius" type="button"><i className="fa fa-pencil" aria-hidden="true"></i></button>
							</div>
						</div>
						<div className="input-group mb-3">
							<input type="text" className="form-control" placeholder="Add Bank Account Number" value="112300987652" />
							<div className="input-group-append">
								<button className="btn btn-theme button-1 text-white ctm-border-radius" type="button"><i className="fa fa-pencil" aria-hidden="true"></i></button>
							</div>
						</div>
						<div className="input-group mb-3">
							<input type="text" className="form-control" placeholder="Add Bank Sort Code" value="LE00652" />
							<div className="input-group-append">
								<button className="btn btn-theme button-1 text-white ctm-border-radius" type="button"><i className="fa fa-pencil" aria-hidden="true"></i></button>
							</div>
						</div>
