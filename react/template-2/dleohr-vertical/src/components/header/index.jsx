										...
										<div className="col-lg-12 col-md-12 col-sm-12">
											...
											<div className="user-info align-right dropdown d-inline-block header-dropdown">
												...
												<div className="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
													...
													<Link className="dropdown-item p-2" to="settings">
														<span className="media align-items-center">
								...
								<div className="d-block d-lg-none">
									...
									<div className="offcanvas-menu" id="offcanvas_menu">
										...
										<div className="user-menu-items px-3 m-0">
											<Link className="px-0 pb-2 pt-0" to="dashboard">
												<span className="media align-items-center">
								...
								<div className="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
									<div className="append mr-auto my-0 my-md-0 mr-auto">
										<ul className="list-group list-group-horizontal-md mr-auto">
											...
											<li className={`mr-1 ${'employees' === url ? 'active' : ''} `}><Link to="/employees/employees-all" className="text-dark btn-ctm-space "><span className="lnr lnr-users pr-0 pr-lg-2"></span><span className="d-none d-lg-inline">Employees</span></Link></li>
											...
											<li className={`mr-1 ${'reviews' === url ? 'active' : ''} `}><Link to="/reviews/overview-reviews" className="text-dark btn-ctm-space" ><span className="lnr lnr-star pr-0 pr-lg-2"></span><span className="d-none d-lg-inline">Reviews</span></Link></li>
											<li className={`mr-1 ${'reports' === url ? 'active' : ''} `}><Link to="/reports/reports" className="btn-ctm-space text-dark"><span className="lnr lnr-rocket pr-0 pr-lg-2"></span><span className="d-none d-lg-inline">Reports</span></Link></li>
											<li className={`mr-1 ${'manage' === url ? 'active' : ''} `}><Link to="/manage/manage" className="btn-ctm-space text-dark" ><span className="lnr lnr-sync pr-0 pr-lg-2"></span><span className="d-none d-lg-inline">Manage</span></Link></li>
											<li className={`mr-1 ${'settings' === url | 'employment' === url ? 'active' : ''} `}><Link to="/settings/settings" className="btn-ctm-space text-dark" ><span className="lnr lnr-cog pr-0 pr-lg-2"></span><span className="d-none d-lg-inline">Settings</span></Link></li>
										</ul>
									</div>
