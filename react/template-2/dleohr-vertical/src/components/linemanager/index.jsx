							...
							<div className="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div className="card-body">
										<div className="list-group list-group-horizontal-lg" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab1' ? 'active' : ''}`} id="v-pills-home-tab"  data-target="#v-pills-home" onClick={()=>this.handlemanage('tab1')}>View & Edit Details</a>
											...
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab3' ? 'active' : ''}`} id="v-pills-messages-tab"  data-target="#v-pills-messages" onClick={()=>this.handlemanage('tab3')}>View Salaries</a>
											<a href="#0" className={`list-group-item ${this.state.tab === 'tab4' ? 'active' : ''}`} id="v-pills-settings-tab"  data-target="#v-pills-settings" onClick={()=>this.handlemanage('tab4')}>View Others Information </a>
										</div>
									</div>
								</div>
                            {/*card*/}
