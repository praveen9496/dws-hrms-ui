                ...
                <Card>
                  ...
                  <Accordion.Collapse eventKey="0">
                    <Card.Body>
                      ...
                      <div className="row">
                        <div className="col-md-12 form-group">
                        <Select options={teams} className="select"/>
                        </div>
                        <div className="col-md-12 form-group">
                        <Select options={linemanager} className="select"/>
                        </div>
                        <div className="col-12 form-group mb-0">
                          <Select options={officename} className="select"/>
                        </div>
                      </div>
                    </Card.Body>
                  </Accordion.Collapse>
                  ...
                  <Accordion.Collapse eventKey="4">
                    <Card.Body>
                      <div className="row">
                        ...
                        <div className="col-12 form-group">
                        <Select options={frequency} className="select"/>
                        </div>
