					 ...
					 <div className="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
								<div className="card-body">
									<ul className="list-group list-group-horizontal-lg">
										<li className="list-group-item text-center active button-5"><Link to="employees-all" className="text-white">All</Link></li>
										<li className="list-group-item text-center button-6"><Link className="text-dark" to="employee-team">Teams</Link></li>
										<li className="list-group-item text-center button-6"><Link className="text-dark" to="employee-office">Offices</Link></li>
									</ul>
								</div>
							</div>
