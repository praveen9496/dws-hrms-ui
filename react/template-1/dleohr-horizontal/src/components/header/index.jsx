...
console.log(employeeId + "hiii");

const profileImageUrl = `http://dwinhrms-eapi.us-e2.cloudhub.io/api/user-profile/profileImage/${employeeId}`;
...
.catch(error => {
    ...
    handleLogout = () => {
        ...
        // Reload the page to clear any cached data or components
        window.location.reload(true); // Pass true to force a reload from the server rather than cache
    }
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div className="user-info align-right dropdown d-inline-block header-dropdown">
                                                ...
                                                <div className="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
                                                    ...
                                                    <button className="dropdown-item p-2" onClick={this.handleLogout}>
                                                        <span className="media align-items-center">
                                ...
                                <div className="d-block d-lg-none">
                                    ...
                                    <div className="offcanvas-menu" id="offcanvas_menu">
                                        ...
                                        <div className="user-menu-items px-3 m-0">
                                            ...
                                            <button className="p-2" onClick={this.handleLogout}>
                                                <span className="media align-items-center">
                                                    <span className="lnr lnr-power-switch mr-3"></span>
                                                    <span className="media-body text-truncate text-left">
